...
|------:|:-------------|-----------:|------------------:|---------:|----------------:|
|    20 | balanced     | 16.984 ± 2.952 |     5.092 ± 0.000 | 0.002 ± 0.001 |   2.782 ± 0.849 |
|    20 | unbalanced   | 16.931 ± 1.646 |     4.980 ± 0.194 | 0.003 ± 0.000 |   2.782 ± 0.849 |
|    50 | balanced     | 23.625 ± 0.742 |     5.091 ± 0.000 | 0.000 ± 0.001 |   3.430 ± 1.377 |
|    50 | unbalanced   | 17.391 ± 1.798 |     5.092 ± 0.000 | 0.002 ± 0.001 |   3.430 ± 1.377 |
|   100 | balanced     | 20.474 ± 3.136 |     5.039 ± 0.092 | 0.002 ± 0.000 |   3.128 ± 0.852 |
|   100 | unbalanced   | 23.649 ± 2.119 |     4.984 ± 0.093 | 0.002 ± 0.000 |   3.128 ± 0.852 |

**Table 8.** Scenario summary — mean ± std across 3 repeated runs (seed 2, 3, 4).
Convergence time = interval between `Ipv4::SetDown()` and `RecomputeRoutingTables()` completion.
